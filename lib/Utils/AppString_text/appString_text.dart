class AppString {
  ...
  static const String myDogIsLittle = "Q. My dog is a little ____, especially \n when around other dogs.";
  ...
  static const String chines01="Timid的意思是缺乏勇氣或信心；容易受到驚嚇，這適合描述一隻狗在其他狗的周圍表現出的從屬或緊張的行為。";
  static const String chines02="Scary (可怕) 和Frightening (嚇人) 表示狗會讓其他人或動物感到恐懼，這與狗對其他狗的反應不符。";
  static const String chines03="Concerned (擔憂) 通常不用來描述狗與其他狗相處時感到壓力的反應。";
